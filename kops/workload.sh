...
sleep 60
kubectl apply -f $HOME/instana/catalo* -f $HOME/instana/user -f $HOME/instana/cart 
sleep 5
kubectl apply -f $HOME/instana/shippin*
sleep 40
kubectl apply -f $HOME/instana/payment -f $HOME/instana/dispatch
sleep 5 
kubectl apply -f $HOME/instana/web

print_message "Instana Deployment Was Successful!"
print_message "Starting expense Project Deployment..."
kubectl apply -f $HOME/expense/mysql
sleep 60
kubectl apply -f $HOME/expense/backend
sleep 30
kubectl apply -f $HOME/expense/frontend
